...
#이미지 불러오기
image=cv2.imread(r"D:\music-sheet-algoritm\sy\music_sheet_jpg\4.jpg", cv2.IMREAD_ANYCOLOR)
...
#전처리 3. 악보 이미지 정규화
normalized_image, staves = modules_sy.normalization(removed_image, staves, 15)
